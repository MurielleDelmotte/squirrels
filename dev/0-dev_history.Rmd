...
fusen::fill_description(
  pkg = here::here(),
  fields = list(
    Title = "Des Outils pour analyser les écureuils de central Park",
    Description = "Une voite à outils de fonctions pour les écureuils.",
    `Authors@R` = c(
      person("Murielle", "Delmotte", email = "murielle@thinkr.fr", role = c("aut", "cre"))
    )
  )
)
...
```{r}
usethis::use_data_raw(name = "nyc_squirrels_reduced")
```
